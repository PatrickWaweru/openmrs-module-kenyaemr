 ...
 */
@Component
public class ETLThreePMGreenCardIndicatorLibrary {
    @Autowired
    private ETLMoh731GreenCardCohortLibrary moh731Cohorts;
    @Autowired
    private ETLThreePMGreenCardCohortLibrary threePMCohorts;
    @Autowired
     ...
     */
    public CohortIndicator getTotalHTSscreened() {
        return cohortIndicator(null,
                map(threePMCohorts.getTotalHTSscreened(), "startDate=${startDate},endDate=${endDate}")
        );
    }
